...
export default function PricingPage() {
  return (
    <main className="legal-shell">
      ...
      <section className="pricing-hero"><p className="eyebrow">Simple pricing</p><h1>One price per screen.</h1><p className="hero-copy">$9 per screen each month. No discounts.</p></section>
      <section className="pricing-grid">
        <article className="panel pricing-card featured"><p className="eyebrow">Screen license</p><h2>$9 <small>/ screen / month</small></h2><p>Each active screen is $9 per month and includes media uploads, scheduling, player health, and community board tools.</p><Link className="button" href="/signup">Start 14 days free</Link></article>
      </section>
